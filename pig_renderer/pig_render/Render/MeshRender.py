...
'''
Render object with per-vertex color 
'''
class MeshRender:
    def __init__(self):
        ...
        self.ColorsBuffer = glGenBuffers(1) 
    ...
    def load_data_colors(self, colors): 
        self.colors3 = colors[self.face_vert].astype('float32')
    ...
    def bind_arrays(self):
        ...
        glBufferData(GL_ARRAY_BUFFER, self.colors3.nbytes, self.colors3, GL_DYNAMIC_DRAW)
